...
#     # Add patient and optionally send SMS
#     def add_patient(self, name, predicted_time, phone=None):
...
#         if phone:
#             # Compose message including QR link
...
# p1 = qs.add_patient("Alice", 10, phone="+919921616017")
# p2 = qs.add_patient("Bob", 15, phone="+917558214666")
# p3 = qs.add_patient("Charlie", 12)  # no phone, no SMS
